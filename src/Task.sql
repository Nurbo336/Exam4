...
-- #6
select name from company join trip on company.id = trip.company  where trip.plane  ='Boeing'
-- #7
select plane from trip where town_to = 'Moscow'
-- #9
select name from company join trip on company.id = trip.company where town_to = 'Vladivostok'
-- #12
select count(plane) from trip where town_to = 'Rostov' and town_from = 'Moscow'
